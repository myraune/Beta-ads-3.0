      ...
      <div className="portal-frame space-y-6 rounded-3xl p-6 md:p-8">
        <header className="flex flex-wrap items-end justify-between gap-4">
          <div>
            ...
            <p className="mt-2 max-w-3xl text-sm text-ink/70 md:text-base">
              Manage launch readiness, monitor live delivery signals, and maintain campaign pacing confidence.
            </p>
          </div>
        ...
        <section className="grid gap-4 lg:grid-cols-[1.1fr_0.9fr]">
          <article className="portal-card rounded-2xl p-5">
            ...
            {loading ? (
              <p className="mt-5 rounded-xl border border-ink/10 bg-white/75 px-4 py-5 text-sm text-ink/70">Loading campaigns...</p>
            ) : campaigns.length === 0 ? (
